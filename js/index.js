...
// 日期、总分、班级排名、年纪排名、语文、数学、英语、物理、生物、地理
const examData = [
  // 进入高三 暑期补课期间
  ['2022/09/01',  512, 3, 133, 96, 102, 94.5, 43, 87, 90]
  ,['2022/10/06',  [425, 484], 3, 107, 89, 58, 108, 55, [53,87], [62,87]]
  // 11 月份第3次月考（原始总分491，总分531；无年级排名，生物赋分，地理赋分, [原始分， 赋分]
  ,['2022/11/16',  [491, 531], 2, "", 105, 96, 122, 55, [56, 77], [57, 76]]
  // 第五次月考
  ,['2023/2/21', [445, 495], 5, 199, 94, 82, 119, 33, [56,85], [61, 82]]
  // 第六次月考
  ,['2023/3/4', [436.5, 490.5], 2, 87, 94, 51, 115.5, 62, [58,83], [56, 85]]
  // 4.1联考(联考排名1543)
  ,['2023/4/1', [477, 526], 1, 92, 100, 94, 113, 52, [64,81], [54, 86]]
  // gaokao （6/7~6/9）
  ,['2023高考', 559, '', '', 108, 91, 126, 65, 79, 90]
]
